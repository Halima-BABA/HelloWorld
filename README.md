...
I'm Halima I like coding with Python in order to build some Machine Learning algorithms. 

So I made this branch in order to do my first snapshot of the master cluster 
every one should make a first copy of the master and work on the first branch not on the master 
